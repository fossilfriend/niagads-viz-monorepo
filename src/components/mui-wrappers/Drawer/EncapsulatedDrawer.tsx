...
export const EncapsulatedDrawer: React.FC<
...
> = ({
    ...
    children,
        ...
        // see https://stackoverflow.com/a/74297048 for typing
            ...
            <>
                <div ref={containerRef} style={{ width: "100%" }}>
                    ...
                    */}
                    ...
                    <div
                        className={clsx(contentClasses.content, {
                            [contentClasses.contentShift]: open,
                        })}>
                        {children}
                    </div>
                </div>
