const data = [
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00115_GRCh38_FEMALE", "type": "link", "value": "Genetic architecture of AD and differential effect between sexes: Females (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00115_GRCh38_MALE", "type": "link", "value": "Genetic architecture of AD and differential effect between sexes: Males (GRCh38)"},
    "attribution": "Wang et al. 2021",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00075_GRCh38_STAGE1", "type": "link", "value": "IGAP Rare Variants: Stage 1 (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00075_GRCh38_STAGE2", "type": "link", "value": "IGAP Rare Variants: Stage 2 (GRCh38)"},
    "attribution": "Kunkle et al. 2019",
    "covariates": "age (defined as age-at-onset for cases and age-at-last exam for controls), sex, and population stratification",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00055_AB42", "type": "link", "value": "CSF: Aβ₄₂ (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00055_GRCh38_PTAU", "type": "link", "value": "CSF: ptau (GRCh38)"},
    "covariates": "adjusted for age, sex, and population stratification",
    "attribution": "Deming et al. 2017",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00055_GRCh38_TAU", "type": "link", "value": "CSF: tau (GRCh38)"},
    "covariates": "adjusted for age, sex, and population stratification",
    "name": "CSF: tau (GRCh38)",
    "attribution": "Deming et al. 2017",
    "publication_date": "2017",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00058_GRCh38", "type": "link", "value": "IGAP: AD Age of Onset Survival (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00056_GRCh38_ALL", "type": "link", "value": "Transethnic LOAD: All Samples (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "African American // European // Israeli-Arab // Japanese",
    "dataset_record_link": {"url": "../track/NG00056_GRCh38_ALL_APOE_ADJ", "type": "link", "value": "Transethnic LOAD: All Samples, adjusted for APOE ε4 (GRCh38)"},
  ...
  },
  {
    ...
    "dataset_record_link": {"url": "../track/NG00056_GRCh38_APOE_E4", "type": "link", "value": "Transethnic LOAD: APOE ε4 Carriers (GRCh38)"},
    "attribution": "Jun et al. 2017",
  ...
  },
  {
    ...
    "population": "African American // European // Israeli-Arab // Japanese",
    "dataset_record_link": {"url": "../track/NG00056_GRCh38_NON_APOE_E4", "type": "link", "value": "Transethnic LOAD: APOE ε4 Non-Carriers (GRCh38)"},
    "covariates": "adjusted for age, sex, and population stratification",
    "attribution": "Jun et al. 2017",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00052_GRCh38", "type": "link", "value": "CSF: CLU (GRCh38)"},
    "name": "CSF: CLU (GRCh38)",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00078_GRCh38_ALL", "type": "link", "value": "IGAP APOE-Stratified Analysis: All Samples (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": "APOE ε4 carrier",
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00078_GRCh38_APOE4_CARRIERS", "type": "link", "value": "IGAP APOE-Stratified Analysis: APOEε4 Carriers (GRCh38)"},
    "attribution": "Jun et al. 2016",
    "covariates": "sex, age, APOEε4 status, and population stratification",
  ...
  },
  {
    ...
    "genotype": "APOE ε4 non-carrier",
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00078_GRCh38_APOE4_NON_CARRIERS", "type": "link", "value": "IGAP APOE-Stratified Analysis: APOEε4 Non-Carriers (GRCh38)"},
    "covariates": "sex, age, APOEε4 status, and population stratification",
    "attribution": "Jun et al. 2016",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00078_GRCh38_INT", "type": "link", "value": "IGAP APOE-Stratified Analysis: SNP - APOEε4 Status Interaction (GRCh38)"},
    "attribution": "Jun et al. 2016",
  ...
  },
  {
    ...
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00040_GRCh38_AD", "type": "link", "value": "Multi-ethnic exome array: AD (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "African/African American // Asian // European // Hispanic or Latin American",
    "dataset_record_link": {"url": "../track/NG00040_GRCh38_FTD", "type": "link", "value": "Multi-ethnic exome array: FTP (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "African/African American // Asian // European // Hispanic or Latin American",
    "dataset_record_link": {"url": "../track/NG00040_GRCh38_PSP", "type": "link", "value": "Multi-ethnic exome array: PSP (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_CAA", "type": "link", "value": "Cerebral amyloid angiopathy (presence vs. absence) (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_HS", "type": "link", "value": "Hippocampal sclerosis of the elderly (presence vs. absence) (GRCh38)"},
    "covariates": "population stratification",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_LEWY", "type": "link", "value": "Lewy body disease (presence vs. absence) (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_LEWY_3", "type": "link", "value": "Lewy body disease (3 category ranking) (GRCh38)"},
    "covariates": "population stratification",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_LEWY_5", "type": "link", "value": "Lewy body disease (5 category ranking) (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_NFT_BGROUPS", "type": "link", "value": "Neurofibrillary tangles (ranked by Braak groups) (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_NFT_BSTAGES", "type": "link", "value": "Neurofibrillary tangles (ranked by Braak stages) (GRCh38)"},
    "covariates": "population stratification",
    "attribution": "Beecham et al. 2014",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_NP", "type": "link", "value": "Neuritic plaques (presence vs. absence) (GRCh38)"},
    "attribution": "Beecham et al. 2014",
    "covariates": "population stratification",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_NP_CERAD", "type": "link", "value": "Neuritic plaques (ranked by CERAD score) (GRCh38)"},
    "attribution": "Beecham et al. 2014",
    "covariates": "population stratification",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_NP_CONS", "type": "link", "value": "Neuritic plaques (presence vs. absence); conservative (GRCh38)"},
    "attribution": "Beecham et al. 2014",
    "covariates": "population stratification",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_NP_RELAX", "type": "link", "value": "Neuritic plaques (presence vs. absence); relaxed (GRCh38)"},
    "covariates": "population stratification",
    "attribution": "Beecham et al. 2014",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_STATUS", "type": "link", "value": "Neuropathologic features of AD and related dementias (case/control) (GRCh38)"},
    "attribution": "Beecham et al. 2014",
    "covariates": "population stratification",
    "name": "Neuropathologic features of AD and related dementias (case/control) (GRCh38)",
    "publication_date": "2014",
    "track": "NG00041_GRCh38_STATUS",
    "neuropathology": "AD/ADRD related neuropathology // Alzheimer's disease/late onset AD (AD/LOAD) // Lewy body disease or neuropathology (LBD) // Vascular brain injury (VBI)"
  },
  {
    "dataset_accession": "NG00041",
    "consortium": null,
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_VBI", "type": "link", "value": "Vascular brain injury (presence vs. absence); relaxed (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00041_GRCh38_VBI_3", "type": "link", "value": "Vascular brain injury (3 category ranking) (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00048_GRCh38", "type": "link", "value": "ADGC LOAD: Age at Onset (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00049_GRCh38_AB42", "type": "link", "value": "CSF: Aβ₄₂ (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00049_GRCh38_PTAU", "type": "link", "value": "CSF: ptau (GRCh38)"},
    "attribution": "Cruchaga et al. 2013",
    "covariates": "adjusted for age, sex, site, and population stratification",
    "name": "CSF: ptau (GRCh38)",
    "publication_date": "2013",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00049_GRCh38_TAU", "type": "link", "value": "CSF: tau (GRCh38)"},
    "name": "CSF: tau (GRCh38)",
    "attribution": "Cruchaga et al. 2013",
    "covariates": "adjusted for age, sex, site, and population stratification",
    "publication_date": "2013",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00036_GRCh38_STAGE1", "type": "link", "value": "IGAP: Stage 1 (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00036_GRCh38_STAGE12", "type": "link", "value": "IGAP: Stages 1 and 2 (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00053_GRCh38", "type": "link", "value": "IGAP Stage 1: ADGC Subset (GRCh38)"},
    "covariates": "adjusted for age, sex, and population stratification",
    "attribution": "Lambert et al. 2013",
  ...
  },
  {
    ...
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00039_GRCh38", "type": "link", "value": "ADGC LOAD: African Americans (GRCh38)"},
  ...
  },
  {
    ...
    "population": "African American",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00039_GRCh38_ADJ", "type": "link", "value": "ADGC LOAD: African Americans - APOE Adj (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00027_GRCh38_ADJ_STAGE1", "type": "link", "value": "ADGC LOAD: Adjusted Stage 1 (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00027_GRCh38_ADJ_STAGE12", "type": "link", "value": "ADGC LOAD: Adjusted Stages 1 and 2 (GRCh38)"},
    "covariates": "age, sex, and APOE4 number",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00027_GRCh38_ADJ_STAGE2", "type": "link", "value": "ADGC LOAD: Adjusted Stage 2 (GRCh38)"},
    "covariates": "age, sex, and APOE4 number",
    "attribution": "Naj et al. 2011",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00027_GRCh38_STAGE1", "type": "link", "value": "ADGC LOAD: Stage 1 (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00027_GRCh38_STAGE12", "type": "link", "value": "ADGC LOAD: Stages 1 and 2 (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00027_GRCh38_STAGE2", "type": "link", "value": "ADGC LOAD: Stage 2 (GRCh38)"},
    "covariates": null,
    "attribution": "Naj et al. 2011",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00073_GRCh38_LANG", "type": "link", "value": "Language predominant AD subgroup (GRCh38)"},
    "attribution": "Crane",
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00073_GRCh38_MEM", "type": "link", "value": "Memory predominant AD subgroup (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00073_GRCh38_MIX", "type": "link", "value": "Multiple substantial cognitive impairments AD subgroup (GRCh38)"},
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00073_GRCh38_NONE", "type": "link", "value": "No domain-specific substantial cognitive impairment AD subgroup (GRCh38)"},
    "attribution": "Crane",
  ...
  },
  {
    ...
    "genotype": null,
    "population": "European",
    "dataset_record_link": {"url": "../track/NG00073_GRCh38_VSP", "type": "link", "value": "Visuospatial predominant AD subgroup (GRCh38)"},
  ...
  },
  {
    ...
    "population": "European",
    "genotype": null,
    "dataset_record_link": {"url": "../track/NG00076_GRCh38", "type": "link", "value": "ADGC LOAD Subset: non-IGAP Discovery Phase (GRCh38)"},
